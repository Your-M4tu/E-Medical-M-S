...
<html lang="en">
<head>
<title>View All Panchayat Details</title>
<meta charset="utf-8">
...
<th>Panchayat</th>
<th>Wards</th>
<th>Public Health Block Number (Lower Limit)</th>
<th>Public Health Block Number (Upper Limit)</th>
</thead>
<tbody>
<?php
...
?>
<tr>
<th> <?php echo"{$row['dstcode']} ";?> </th>
<th> <?php echo" {$row['phc']} ";?>   </th>
<th> <?php echo"{$row['panchayat']} ";?> </th>
<th> <?php echo" {$row['wards']} ";?>   </th>
<th> <?php echo" {$row['pbhl']} ";?>  </th>
<th> <?php echo" {$row['pbhu']} ";?>  </th>
</tr>
<?php
}
?>
